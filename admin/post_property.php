...
if(isset($_POST['post'])){
   ...
   if(!empty($image_02)){
      if($image_02_size > 9000000000000){
   ...
   if($image_01_size > 90000000000){
      $warning_msg[] = 'image 01 size too large!';
   }else{
      $insert_property = $conn->prepare("INSERT INTO `property`(id, admin_id, property_name, address, price, type, offer, bhk, deposite, bedroom, bathroom, balcony, carpet,  total_floors, loan, image_01, image_02, image_03, image_04, image_05, description) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"); 
      $insert_property->execute([$id, $admin_id, $property_name, $address, $price, $type, $offer, $bhk, $deposite, $bedroom, $bathroom, $balcony, $carpet, $total_floors, $loan, $rename_image_01, $rename_image_02, $rename_image_03, $rename_image_04, $rename_image_05, $description]);
