...
if(isset($_POST['update'])){
   ...
   $update_listing = $conn->prepare("UPDATE `property` SET property_name = ?, address = ?, price = ?, type = ?, offer = ?, bhk = ?, deposite = ?, bedroom = ?, bathroom = ?, carpet = ?, total_floors = ?, loan = ?, description = ? WHERE id = ?");   
   $update_listing->execute([$property_name, $address, $price, $type, $offer, $bhk, $deposite, $bedroom, $bathroom, $carpet, $total_floors, $loan, $description, $update_id]);
