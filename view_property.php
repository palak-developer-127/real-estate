...
<body>
    ...
    <section class="view-property">
        ...
        <?php
        $select_properties = $conn->prepare("SELECT * FROM `property` WHERE id = ? AND `status` = 'E'ORDER BY date DESC LIMIT 1");
        ...
        <div class="details">
            ...
            <div class="info">
                <p><i class="fas fa-indian-rupee-sign"></i><span>
            ...
            <div class="flex">
                <div class="box">
                    ...
                    <p><i>bedroom :</i><span>
                            <?= $fetch_property['bedroom']; ?>
                        </span></p>
                    <p><i>bathroom :</i><span>
                            <?= $fetch_property['bathroom']; ?>
                        </span></p>
                    <p><i>balcony :</i><span>
                            <?= $fetch_property['balcony']; ?>
                        </span></p>
                </div>
                <div class="box">
                    ...
                    <p><i>total floors :</i><span>
                            <?= $fetch_property['total_floors']; ?>
                        </span></p>
                    <p><i>loan :</i><span>
                            <?= $fetch_property['loan']; ?>
                        </span></p>
            ...
            <form action="" method="post" class="flex-btn">
                ...
                <?php
                        if ($select_saved->rowCount() > 0) {
                            ?>
                <a><button type="submit" name="save" class="save"><i
                ...
                <?php
                        ...
                        ?>
                <a href="order.php?get_id=<?= $fetch_property['id']; ?>"> <input type="button" value="Agent" name="send"
                        class="btn"> </a>
                <!-- <a href="pay/index.php"> pay</a>-->
                <a href="pay/index.php"> <input type="button" value="purchase" name="send" class="btn"> </a>
            </form>
        </div>
        <?php
            }
